...
public class Difference {
    ...
    public static void main(String[] args) {
        ...
        /**
         * 
         * ArrayList só perde em
         * - Adicionar ou remover elementos do meio
         * 
         * Mas 
         * - Fornece acesso rápido aos elementos usando um índice numérico e 
         * - é eficiente na inserção e remoção de elementos no final da lista.
         * 
         */
